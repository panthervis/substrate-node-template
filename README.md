...
<pre><code class="hljs css language-bash"> git <span class="hljs-built_in">clone</span> -b v2.0.0 --depth 1 https://github.com/Praexor/substrate-node-template.git
...
git <span class="hljs-built_in">clone</span> -b v2.0.0 --depth 1 https://github.com/Praexor/substrate-front-end-template.git
